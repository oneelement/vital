...
export default function Notification({ message = 'Saved' }: NotificationProps) {
  return (
    <div aria-live="assertive" className="fixed bottom-0 right-0 flex items-end px-4 py-6 sm:items-start max-w-xs w-full">
